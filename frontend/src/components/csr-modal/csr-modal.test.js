...
describe('<CSRModal />', () => {
    ...
    it("CSRModal modal rendering", () => {
        ...
        const wrapper = shallow(<CSRModal onCSRUpdate={mockOnCSRUpdate} onModalChange={mockOnModalChange} open={true}/>);
    ...
    it("CSRModal modal not opened", () => {
        const mockOnCSRUpdate = jest.fn();
        const mockOnModalChange = jest.fn();
        const wrapper = shallow(<CSRModal onCSRUpdate={mockOnCSRUpdate} onModalChange={mockOnModalChange} open={false}/>);
