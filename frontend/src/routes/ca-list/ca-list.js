...
import { Grid, List, ListItem, ListItemText, Card, CardContent, Typography, Divider, Container, Button } from '@material-ui/core';
    ...
    return(
        <Container maxWidth="md">
            ...
            <Grid container spacing={2}>
                        ...
                        {CAs !== null && (
                            <Grid item xs={12}>
                                <List component="nav" className={classes.list}>
                                    {CAs.map((ca, i) => (
                                        <React.Fragment>            
                                            <ListItem key={ca.ca_name} button onClick={() => handleCAChange(ca.ca_name)}>
                ...
                <Grid item xs={6}>
                    <Button fullWidth variant="contained" color="primary" disabled={selectedCA == null} onClick={() => handleRegister(selectedCA)}>
                        Register into Cloud provider
                    </Button>
                </Grid>
                <Grid item xs={6}>
                    <Button fullWidth variant="contained" color="secondary" disabled={selectedCA == null} onClick={() => handleRevoke(selectedCA)}>
                        Revoke CA
                    </Button>
                </Grid>
            </Grid>
